...
def main():
    ...
    parser.add_argument('--nsfw_filter', type=bool, default=nsfw_filter,
                        help='True filters out nsfw images, and False does not')
    args = parser.parse_args()
    
    query_results = praw.models.Subreddit(r, args.subreddit).search(query=args.query, nsfw=args.nsfw_filter)# limit for debug
